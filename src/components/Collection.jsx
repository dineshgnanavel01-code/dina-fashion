        ...
        <div className="flex flex-wrap justify-center gap-4 pt-6 text-xs uppercase tracking-[0.2em]">
          {categories.map((cat) => (
            <button
              ...
              className={`pb-1 transition-all duration-300 relative ${activeCategory === cat ? 'text-[#111111] font-medium border-b border-[#111111]' : 'text-[#77736c] hover:text-[#111111]'}`}
            >
              {cat}
            </button>
          ))}
          ...
          <div 
            ...
            <div className="flex justify-between items-start text-xs tracking-wider pt-1">
              <div className="space-y-1">
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#b59b62] block font-medium">
                  {product.category}
                </span>
                <h3 className="font-serif text-sm text-[#111111] tracking-wide group-hover:text-[#b59b62] transition-colors duration-300">
                  {product.name}
                </h3>
              </div>
